...
namespace TraversalCoreProject.Areas.Admin.Controllers
{
    ...
    public class DestinationCQRSController : Controller
    {
        ...
        public DestinationCQRSController(GetAllDestinationHandlers getAllDestinationHandlers, GetDestinationByIDQueryHandler getDestinationByIDQueryHandler, CreateDestinationCommandHandler createDestinationCommandHandler, RemoveDestinationCommandHandler removeDestinationCommandHandler, UpdateDestinationCommandHandler updateDestinationCommandHandler)
        {
