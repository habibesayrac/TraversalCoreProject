...
namespace SignalRApiForSql.Model
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "select tarih,[1],[2],[3],[4],[5],[6] from (select[City],CityVisitCount,Cast([VisitDate] as Date) as tarih from Visitors)as visitTable Pivot " +
                    "(Sum(CityVisitCount) For City in([1],[2],[3],[4],[5],[6])) as pivottable order by tarih asc";
